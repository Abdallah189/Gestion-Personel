            ...
            <div class="modal-dialog">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" id="email" placeholder="Email de Responsable">
                    </div>
                    <div class="form-group">
                        <label class="control-label " for="sexe">Sexe:</label>
                        <input type="text" name="paysE" class="form-control" id="sexe" placeholder="Sexe">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-dialog">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="paysE" class="form-control" id="sexeEdit" placeholder="Sexe">
                    </div>
                    <div class="form-group">
